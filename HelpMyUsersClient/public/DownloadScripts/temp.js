function writeJS(){var temp = "<ol id='joyRideTipContent'><li data-id='ftft' data-button='Close' data-options='tipLocation:top;tipAnimation:fade'><h2>ffgfjg</h2><p>fjjfjfg</p></li></ol>";    document.write(temp);
}
writeJS();
